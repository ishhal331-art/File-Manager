      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-8 pb-36 sm:pb-44 space-y-6 sm:space-y-8">
        {activeTab === 'users' && (
          <div className="space-y-6 sm:space-y-8 animate-fade-in" id="admin-users-view">
            ...
            {/* ALL INGESTED DOCUMENTS & COMPLIANCE FILES (GLOBAL LEDGER) */}
            <div className="bg-[#FCFBF8] rounded-2xl sm:rounded-[32px] p-4 sm:p-6 shadow-[0_15px_35px_rgba(110,85,190,0.08)] border border-[#F0ECE1] space-y-4">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 pb-3 border-b border-[#F2ECE0]">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">
                      Real-time inventory of all user documents stored and processed in the system.
                    </p>
                  </div>
                </div>
              ...
              {allUploadedFiles.length === 0 ? (
                <div className="p-8 text-center text-slate-400 text-xs font-medium bg-[#F8F6EF] rounded-2xl border border-dashed border-[#E0DBCF]">
                  No files have been uploaded by any user yet. User uploads will immediately appear here.
                </div>
              ) : (
